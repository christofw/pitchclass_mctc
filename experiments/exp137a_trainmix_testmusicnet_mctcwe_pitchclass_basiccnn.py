...
path_test_data = os.path.join(path_data_basedir, 'MusicNet', 'hcqt_hs512_o6_h5_s1')
path_test_annot = os.path.join(path_data_basedir, 'MusicNet', 'pitchclass_hs512_nooverl')
...
train_dataset_params['stride'] = 40
val_dataset_params['stride'] = 40
...
train_dataset_params['stride'] = 200
val_dataset_params['stride'] = 200
...
if do_train:
    train_set = torch.utils.data.ConcatDataset([train_set_schubertmix, train_set_maestro])
...
if do_val:
    val_set = torch.utils.data.ConcatDataset([val_set_schubertmix, val_set_maestro])
